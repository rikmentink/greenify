...
public class InterventionTest {
    ...
    void interventionAddPhase() {
        Phase phase = new Phase(1L, PhaseName.DEVELOPMENT, "Description", intervention, new ArrayList<>());
    ...
    void interventionAddThreePhases() {
        Phase phase1 = new Phase(1L, PhaseName.DEVELOPMENT, "Description", intervention, new ArrayList<>());
        Phase phase2 = new Phase(2L, PhaseName.EXECUTION, "Description", intervention, new ArrayList<>());
        Phase phase3 = new Phase(3L, PhaseName.EVALUATION, "Description", intervention, new ArrayList<>());
